        ...
        <div className="flex items-center justify-between gap-2 h-14">
          ...
          <div className="hidden lg:flex items-center gap-1 flex-wrap">
            ...
            <a href="https://mypaisahq.com/blog" target="_blank" rel="noopener noreferrer">
              <Button size="sm" data-testid="link-nav-knowledge-hub">
                Knowledge Hub
              </Button>
            </a>
          </div>
        ...
        <div className="lg:hidden border-t bg-background">
          <div className="max-w-7xl mx-auto px-4 py-3 flex flex-col gap-1">
            ...
            <a href="https://mypaisahq.com/blog" target="_blank" rel="noopener noreferrer" onClick={() => setOpen(false)}>
              <Button className="w-full justify-start" data-testid="link-mobile-knowledge-hub">
                Knowledge Hub
              </Button>
            </a>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex flex-col gap-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <a href="https://mypaisahq.com/blog" target="_blank" rel="noopener noreferrer" data-testid="link-footer-knowledge-hub">
              <Button size="sm">
                Knowledge Hub
              </Button>
            </a>
